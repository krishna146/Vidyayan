...
class TeacherRegistrationActivity3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var checkedSubArray11thOr12th = booleanArrayOf(
            false,
            false,
            false,
            false
        ...
        txtSelectClass.setOnClickListener() {
            ...
            builder.setMultiChoiceItems(classArray, checkedClassArray) { _, which, isChecked ->
                ...
                //val currentItem = classList[which]
        ...
        txtSelectSubject.setOnClickListener() {
            ...
            if (classList[a] == "12th") {
                ...
                builder.setMultiChoiceItems(classList, checkedSubArray12th) { _, which, isChecked ->
                    ...
                    checkedSubArray11thOr12th[which] = isChecked
            ...
            if (classList[a] == "11th") {
                ...
                builder.setMultiChoiceItems(subArray, checkedSubArray11thOr12th) { _, which, isChecked ->

                    // Update the current focused item's checked status
                    checkedSubArray11thOr12th[which] = isChecked
                    /*// Get the current focused item
                    val currentItem = subList[which]
                    // Notify the current action
                    Toast.makeText(
                        applicationContext,
                        currentItem + " " + isChecked,
